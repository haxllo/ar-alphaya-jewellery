      ...
      <div className="prose prose-lg max-w-none">
        ...
        <section className="mb-12">
          ...
          <div className="space-y-6">
            <p className="text-gray-700">
              To return an item, please contact us first at <a href="mailto:info@aralphayajewellery.com" className="text-blue-600 hover:underline font-semibold">info@aralphayajewellery.com</a> to receive return instructions.
            </p>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
              ...
              <div className="text-blue-800 space-y-2">
                ...
                <p><strong>Email:</strong> <a href="mailto:info@aralphayajewellery.com" className="hover:underline">info@aralphayajewellery.com</a></p>
