...
export default function PoliciesPage() {
  return (
    <main className="mx-auto max-w-5xl px-6 py-12">
      <h1 className="font-serif text-4xl text-nocturne-900 mb-3">Policies</h1>
      <p className="text-nocturne-600 mb-10">Last updated: August 28, 2025</p>

      {/* Quick Navigation */}
      <div className="mb-12 flex flex-wrap gap-3">
        <a href="#returns" className="rounded-full border border-nocturne-200 px-5 py-2 text-sm font-medium text-nocturne-700 transition-colors hover:bg-nocturne-50">
          Returns Policy
        </a>
        <a href="#privacy" className="rounded-full border border-nocturne-200 px-5 py-2 text-sm font-medium text-nocturne-700 transition-colors hover:bg-nocturne-50">
          Privacy Policy
        </a>
        <a href="#terms" className="rounded-full border border-nocturne-200 px-5 py-2 text-sm font-medium text-nocturne-700 transition-colors hover:bg-nocturne-50">
          Terms & Conditions
        </a>
      </div>
      ...
      <section id="returns" className="mb-16 scroll-mt-20">
        <div className="rounded-3xl border border-nocturne-100 bg-white/80 p-8 shadow-subtle">
          <h2 className="font-serif text-3xl text-nocturne-900 mb-6">Returns & Exchanges</h2>
          
          <div className="prose prose-gray max-w-none space-y-6 text-nocturne-700">
            <p>
            ...
            <div className="grid md:grid-cols-2 gap-6 my-8">
              <div className="rounded-2xl border border-nocturne-100 bg-nocturne-50/50 p-5">
                <h3 className="text-lg font-semibold text-nocturne-900 mb-3">✓ Eligible for Return</h3>
                <ul className="space-y-2 text-sm text-nocturne-600">
            ...
            <div className="my-6">
              <h3 className="text-xl font-semibold text-nocturne-900 mb-3">Refunds</h3>
            ...
            <div className="my-6">
              <h3 className="text-xl font-semibold text-nocturne-900 mb-3">Defective or Damaged Items</h3>
      ...
      <section id="privacy" className="mb-16 scroll-mt-20">
        <div className="rounded-3xl border border-nocturne-100 bg-white/80 p-8 shadow-subtle">
          <h2 className="font-serif text-3xl text-nocturne-900 mb-6">Privacy Policy</h2>
          ...
          <div className="prose prose-gray max-w-none space-y-6 text-nocturne-700">
            ...
            <div className="my-6">
              <h3 className="text-xl font-semibold text-nocturne-900 mb-3">Information We Collect</h3>
            ...
            <div className="my-6">
              <h3 className="text-xl font-semibold text-nocturne-900 mb-3">How We Use Your Information</h3>
              <ul className="space-y-2 text-sm">
            ...
            <div className="my-6">
              <h3 className="text-xl font-semibold text-nocturne-900 mb-3">Data Security</h3>
            ...
            <div className="my-6">
              <h3 className="text-xl font-semibold text-nocturne-900 mb-3">Your Rights</h3>
              ...
              <p className="mt-4 text-sm">To exercise these rights, contact us at <a href="mailto:aralphayajewellery@gmail.com" className="text-nocturne-900 underline">aralphayajewellery@gmail.com</a></p>
            </div>

            <div className="my-6">
              <h3 className="text-xl font-semibold text-nocturne-900 mb-3">Cookies</h3>
            ...
            <div className="my-6">
              <h3 className="text-xl font-semibold text-nocturne-900 mb-3">Third-Party Services</h3>
            ...
            <div className="my-6">
              <h3 className="text-xl font-semibold text-nocturne-900 mb-3">Children's Privacy</h3>
      ...
      <section id="terms" className="mb-16 scroll-mt-20">
        <div className="rounded-3xl border border-nocturne-100 bg-white/80 p-8 shadow-subtle">
          <h2 className="font-serif text-3xl text-nocturne-900 mb-6">Terms & Conditions</h2>
          ...
          <div className="prose prose-gray max-w-none space-y-6 text-nocturne-700">
            ...
            <div className="my-6">
              <h3 className="text-xl font-semibold text-nocturne-900 mb-3">Product Information</h3>
            ...
            <div className="my-6">
              <h3 className="text-xl font-semibold text-nocturne-900 mb-3">Orders & Payment</h3>
              <ul className="space-y-2 text-sm">
            ...
            <div className="my-6">
              <h3 className="text-xl font-semibold text-nocturne-900 mb-3">Intellectual Property</h3>
            ...
            <div className="my-6">
              <h3 className="text-xl font-semibold text-nocturne-900 mb-3">Prohibited Activities</h3>
            ...
            <div className="my-6">
              <h3 className="text-xl font-semibold text-nocturne-900 mb-3">Limitation of Liability</h3>
            ...
            <div className="my-6">
              <h3 className="text-xl font-semibold text-nocturne-900 mb-3">Governing Law</h3>
              <p>These terms are governed by the laws of Sri Lanka. Any disputes will be resolved in the courts of Sri Lanka.</p>
            </div>

            <div className="my-6">
              <h3 className="text-xl font-semibold text-nocturne-900 mb-3">Changes to Terms</h3>
      ...
      <section className="rounded-3xl border border-gold-200/60 bg-gold-50/30 p-8 text-center">
        <h2 className="font-serif text-2xl text-nocturne-900 mb-3">Questions About Our Policies?</h2>
        <p className="text-nocturne-600 mb-6">We're here to help. Reach out anytime.</p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2 rounded-full border border-nocturne-200 bg-white px-6 py-3 text-sm font-semibold text-nocturne-700 transition-transform duration-300 hover:-translate-y-0.5 hover:border-nocturne-400"
          >
      ...
      <div className="mt-12 text-center">
        <Link 
          href="/" 
          className="text-sm font-medium text-nocturne-600 underline-offset-4 hover:text-foreground hover:underline"
        >
          ← Back to Home
        </Link>
      </div>
