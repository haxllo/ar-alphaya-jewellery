          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-sm text-white/70">
              <p className="flex items-center gap-2">
                ...
                <a href="mailto:aralphayajewellery@gmail.com" className="transition-colors hover:text-white leading-none">Email Us</a>
              </p>
              <p className="flex items-center gap-2">
                <svg className="h-4 w-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <a href="tel:+94774293406" className="transition-colors hover:text-white leading-none">+94 77 429 3406</a>
              </p>
