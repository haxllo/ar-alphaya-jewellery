        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-[1.2fr_repeat(3,1fr)]">
            ...
            <ul className="space-y-3 text-sm text-white/70">
              ...
              <li>
                <button
                  ...
                  className="p-0 m-0 bg-transparent border-0 transition-colors hover:text-white cursor-pointer font-inherit text-inherit leading-inherit appearance-none"
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-sm text-white/70">
              ...
              <li className="text-xs">143/5 Rainbow Park, Temple Road,<br/>Kengalla 20186, Sri Lanka</li>
            </ul>
            <a
