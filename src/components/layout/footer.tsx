        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/cart" className="text-neutral-300 hover:text-white">Cart</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="/collections/rings" className="text-neutral-300 hover:text-white">Rings</Link></li>
              <li><Link href="/collections/earrings" className="text-neutral-300 hover:text-white">Earrings</Link></li>
              <li><Link href="/collections/pendants" className="text-neutral-300 hover:text-white">Pendants</Link></li>
              <li><Link href="/collections/bracelets-bangles" className="text-neutral-300 hover:text-white">Bracelets & Bangles</Link></li>
            </ul>
          </div>
