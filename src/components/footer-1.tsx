      ...
      <div className="mx-auto max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-6 gap-8 lg:gap-12 px-8 py-12 lg:py-16">
          ...
          <div className="md:col-span-3 lg:col-span-1 space-y-4">
            <h3 className="text-xs font-medium uppercase tracking-wider text-deep-black/60">
              Resources
            </h3>
          ...
          <div className="md:col-span-6 lg:col-span-1 space-y-4">
            ...
            <div className="space-y-3">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 rounded-full bg-forest-deep px-4 py-2.5 text-xs font-semibold uppercase tracking-wider text-white transition-all hover:bg-forest-deep-light"
              >
        ...
        <div className="border-t border-deep-black/5 px-8 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex flex-wrap gap-6 text-xs text-deep-black/50">
              <Link href="/policies#returns" className="text-deep-black/80 hover:text-deep-black transition-colors">
                Returns
              </Link>
              <Link href="/policies#privacy" className="text-deep-black/80 hover:text-deep-black transition-colors">
                Privacy
              </Link>
              <Link href="/policies#terms" className="text-deep-black/80 hover:text-deep-black transition-colors">
                Terms
              </Link>
            </div>
          </div>
