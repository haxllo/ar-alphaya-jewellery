...
export function generateSiteCSP(): string {
  ...
  return [
    ...
    "img-src 'self' https: data: blob: https://ucarecdn.com https://*.ucarecdn.com https://ucarecd.net https://*.ucarecd.net https://flagcdn.com",
    "connect-src 'self' https: wss: https://upload.uploadcare.com https://api.uploadcare.com https://ucarecdn.com https://*.ucarecdn.com https://ucarecd.net https://*.ucarecd.net",
